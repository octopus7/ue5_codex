(function (global) {
  ...
  const poseKeys = [
    ...
    },
    {
      frame: 5,
      name: "load_pivot",
      pelvis: [-1.8, 91.4, -1.0, -6.0, -30.0, 7.0],
      chest: [6.0, 19.0, -4.0],
      neck: [-1.5, -6.0, 1.0],
      head: [-2.0, -8.0, 1.0],
    ...
    },
    {
      frame: 9,
      name: "knee_chamber",
      pelvis: [-2.8, 94.0, 0.5, -3.0, 8.0, 10.0],
      chest: [3.0, -12.0, -5.0],
      neck: [-1.0, 3.0, 1.0],
      head: [-2.0, 5.0, 1.0],
    ...
    },
    {
      frame: 14,
      name: "shin_whip",
      pelvis: [-1.2, 95.2, 1.0, 2.0, 56.0, 6.0],
      chest: [1.0, -34.0, -4.0],
      neck: [-1.0, 8.0, 1.0],
      head: [-2.0, 12.0, 1.0],
    ...
    },
    {
      frame: 16,
      name: "impact_hold",
      pelvis: [-0.8, 94.6, 1.4, 1.0, 72.0, 4.0],
      chest: [2.0, -42.0, -3.0],
      neck: [-1.0, 10.0, 1.0],
      head: [-2.0, 14.0, 1.0],
    ...
    },
    {
      frame: 19,
      name: "recoil_chamber",
      pelvis: [-1.7, 94.0, 0.8, -2.0, 34.0, 7.0],
      chest: [3.0, -18.0, -4.0],
      neck: [-1.0, 5.0, 1.0],
      head: [-2.0, 7.0, 1.0],
      lUpper: [17.0, -9.0, 24.0],
    ...
    },
    {
      frame: 24,
      name: "step_down",
      pelvis: [0.3, 92.4, -0.4, -4.0, -2.0, 2.0],
      chest: [4.0, 4.0, -1.0],
      neck: [-1.0, -1.0, 0.0],
      head: [-2.0, -2.0, 0.0],
    ...
    },
    {
      frame: 27,
      name: "guard_recover",
      pelvis: [0.0, 93.0, 0.0, -2.0, -8.0, 1.0],
      chest: [3.0, 7.0, -1.0],
      neck: [-1.0, -2.0, 0.0],
      head: [-2.0, -4.0, 0.0],
      lUpper: [14.0, -12.0, 20.0],
  ...
  const data = {
    ...
    style: {
      intent: "A heavy realistic right-leg roundhouse kick with planted left-foot pivot, hip-driven chamber, whipping shin path, impact hold, recoil, and guarded recovery.",
      notes: [
        "Left support foot remains grounded and pivots around the ball instead of translating.",
        "Pelvis yaw builds from a loaded wind-up into a strong impact rotation while the chest counter-rotates for mass and balance.",

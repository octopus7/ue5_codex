(function (global) {
  ...
  const poseKeys = [
    ...
    },
    {
      ...
      pelvis: pelvis(-1.5, 82.4, -2.3, -10, -38, 3),
      chest: [10, -4, -4],
      neck: [-4, -18, 1],
      head: [-5, -23, 1],
      lUpper: vec(15, -10, 18),
    ...
    },
    {
      ...
      pelvis: pelvis(-1.0, 96.5, 1.0, -5, 58, 1),
      chest: [5, -18, -7],
      neck: [-2, -28, 1],
      head: [-3, -34, 1],
      lUpper: vec(18, -7, 10),
    ...
    },
    {
      ...
      pelvis: pelvis(-0.8, 108.2, 5.0, 1, 146, -2),
      chest: [1, 54, -9],
      neck: [-1, -34, 2],
      head: [-2, -42, 2],
      lUpper: vec(19, -8, -1),
    ...
    },
    {
      ...
      pelvis: pelvis(0.8, 114.0, 9.0, 5, 248, -5),
      chest: [-1, 138, -11],
      neck: [0, -38, 2],
      head: [-1, -48, 2],
      lUpper: vec(17, -11, -8),
    ...
    },
    {
      ...
      pelvis: pelvis(2.0, 112.5, 11.5, 4, 334, -7),
      chest: [-3, 232, -12],
      neck: [0, -32, 2],
      head: [-1, -43, 2],
      lUpper: vec(18, -10, -12),
    ...
    },
    {
      ...
      pelvis: pelvis(1.2, 105.5, 9.0, 0, 388, -4),
      chest: [2, 304, -8],
      neck: [-1, -22, 1],
      head: [-2, -30, 1],
      lUpper: vec(16, -12, -3),
    ...
    },
    {
      ...
      pelvis: pelvis(0.5, 86.0, 4.0, -8, 410, -2),
      chest: [8, 352, -5],
      neck: [-3, -14, 1],
      head: [-4, -20, 1],
      lUpper: vec(14, -12, 10),
    ...
    },
    {
      ...
      pelvis: pelvis(0, 81.0, 1.0, -12, 382, 0),
      chest: [12, 360, -2],
      neck: [-4, -8, 0],
      head: [-5, -11, 0],
      lUpper: vec(13, -12, 15),
    ...
    },
    {
      ...
      pelvis: pelvis(0, 91.5, 0, -3, 352, 0),
      chest: [5, 350, 0],
      neck: [-1, -4, 0],
      head: [-2, -7, 0],
      lUpper: vec(13, -13, 16),
  ...
  const data = {
    ...
    style: {
      intent: "A heavy, realistic jumping roundhouse kick with crouched load, airborne full-turn hip spin, impact, recoil, and weighted landing absorption.",
      notes: [
        "The airborne span from frames 10 through 24 deliberately has no foot contacts.",
        "Pelvis yaw is authored as an unwrapped spin from the guarded stance through roughly one full body-axis turn, with most of the rotation happening before and through the airborne impact.",
        "Chest, neck, and head yaw lag behind the pelvis during takeoff, chamber, and impact so the spin reads as a heavy torso-driven kick rather than a leg-only swing.",

  ...
  const keyposes = [
    {
      ...
      archery: bow(vec(24, 116, 27), vec(27, 158, 30), vec(21, 75, 24), vec(-10, 112, -3), vec(55, 116, 55), false)
    },
    {
      frame: 8,
      ...
      archery: bow(vec(31, 122, 42), vec(35, 166, 46), vec(27, 82, 38), vec(2, 120, 8), vec(60, 123, 67), false)
    },
    {
      frame: 16,
      name: "draw_expands",
      ...
      archery: bow(vec(36, 124, 52), vec(41, 169, 58), vec(31, 82, 46), vec(-9, 123, -6), vec(70, 124, 76), false)
    },
    {
      frame: 26,
      ...
      archery: bow(vec(40, 124, 58), vec(46, 169, 65), vec(34, 81, 50), vec(-16, 124, -18), vec(77, 124, 87), false)
    },
    {
      frame: 31,
      name: "release_snap",

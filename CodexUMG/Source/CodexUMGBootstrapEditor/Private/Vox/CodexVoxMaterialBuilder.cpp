...
bool FCodexVoxMaterialBuilder::CreateOrUpdateSharedMaterial(UMaterial*& OutMaterial, FString& OutError)
{
	...
	if (VertexColorExpression == nullptr || RoughnessExpression == nullptr || SpecularExpression == nullptr)
	{
	...
	UMaterialEditingLibrary::ConnectMaterialProperty(VertexColorExpression, TEXT(""), MP_BaseColor);

...
#define LOCTEXT_NAMESPACE "ProjectBootstrapperDialogSettingsCustomization"

TSharedRef<IDetailCustomization> FProjectBootstrapperDialogSettingsCustomization::MakeInstance()
{
	return MakeShared<FProjectBootstrapperDialogSettingsCustomization>();
}

void FProjectBootstrapperDialogSettingsCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
	...
	TWeakObjectPtr<UProjectBootstrapperDialogSettings> DialogSettings;
	for (const TWeakObjectPtr<UObject>& Object : CustomizedObjects)
	{
		if (UProjectBootstrapperDialogSettings* Settings = Cast<UProjectBootstrapperDialogSettings>(Object.Get()))
		{
	...
	[
		...
		[
			...
			{
				if (UProjectBootstrapperDialogSettings* Settings = DialogSettings.Get())
				{
					FProjectBootstrapperModule& Module = FModuleManager::LoadModuleChecked<FProjectBootstrapperModule>(TEXT("ProjectBootstrapper"));
